...
## News
* `August 30, 2022`: We've released the inference code, the trained  <a href="https://github.com/CAIC-AD/YOLOPv2/releases/download/V0.0.1/yolopv2.pt">model</a> and published web demo [Huggingface Spaces 🤗](https://huggingface.co/spaces/hank1996/yolopv2) just enjoy it !
